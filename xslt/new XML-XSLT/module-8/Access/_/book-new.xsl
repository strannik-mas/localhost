		...
		<html>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						<col style="WIDTH: 12.566cm"/>
						<col style="WIDTH: 6.216cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.56cm"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
					...
					<tbody id="CTRL2">
						<xsl:for-each select="book">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('price', '#,##0.00&quot;р.&quot;;-#,##0.00&quot;р.&quot;', 'auto', '1049', 6)"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
